      ...
      <div className="w-full bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 py-12 lg:py-16">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="max-w-xl space-y-4">
            <div className="h-6 w-32 rounded-full bg-indigo-400/20 animate-pulse" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[1, 2, 3, 4, 5, 6].map((i) => (
            ...
            >
              ...
              <div className="h-6 w-2/3 rounded-lg bg-slate-200 animate-pulse" />
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <div className="h-10 w-28 rounded-xl bg-brand-400/40 animate-pulse" />
              </div>
            </div>
          ))}
        </div>
